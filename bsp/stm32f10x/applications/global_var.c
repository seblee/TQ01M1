...
const conf_reg_map_st conf_reg_map_inst[CONF_REG_MAP_NUM] = {
    ...
    {43, &g_sys.config.ComPara.u16Sterilize_Time[0], 1, 0xFFFF, 1, 2, 1, NULL},
    {44, &g_sys.config.ComPara.u16Sterilize_Interval[0], 1, 0xFFFF, 1, 2, 1, NULL},
    ...
    {53, &g_sys.config.ComPara.u16Sterilize_Time[1], 1, 0xFFFF, 1, 2, 1, NULL},
    {54, &g_sys.config.ComPara.u16Sterilize_Interval[1], 1, 0xFFFF, 1, 2, 1, NULL},
    ...
    {108, &g_sys.config.ComPara.u16Sterilize_Time[2], 1, 0xFFFF, 1, 2, 1, NULL},
    {109, &g_sys.config.ComPara.u16Sterilize_Time[3], 1, 0xFFFF, 1, 2, 1, NULL},
    {110, &g_sys.config.ComPara.u16Sterilize_Time[4], 1, 0xFFFF, 1, 2, 1, NULL},
    {111, &g_sys.config.ComPara.u16Sterilize_Time[5], 1, 0xFFFF, 1, 2, 1, NULL},
    {112, &g_sys.config.ComPara.u16Sterilize_Time[6], 1, 0xFFFF, 1, 2, 1, NULL},
    {113, &g_sys.config.ComPara.u16Sterilize_Time[7], 1, 0xFFFF, 1, 2, 1, NULL},
    {114, &g_sys.config.ComPara.u16Sterilize_Time[8], 1, 0xFFFF, 1, 2, 1, NULL},
    {115, &g_sys.config.ComPara.u16Sterilize_Time[9], 1, 0xFFFF, 1, 2, 1, NULL},
    {116, &g_sys.config.ComPara.u16Sterilize_Time[10], 1, 0xFFFF, 1, 2, 1, NULL},
    {117, &g_sys.config.ComPara.u16Sterilize_Time[11], 1, 0xFFFF, 1, 2, 1, NULL},
    {118, &g_sys.config.ComPara.u16Sterilize_Time[12], 1, 0xFFFF, 1, 2, 1, NULL},
    {119, &g_sys.config.ComPara.u16Sterilize_Time[13], 1, 0xFFFF, 1, 2, 1, NULL},
    {120, &g_sys.config.ComPara.u16Sterilize_Time[14], 1, 0xFFFF, 1, 2, 1, NULL},
    {121, &g_sys.config.ComPara.u16Sterilize_Time[15], 1, 0xFFFF, 1, 2, 1, NULL},
    {122, &g_sys.config.ComPara.u16Sterilize_Time[16], 1, 0xFFFF, 1, 2, 1, NULL},
    {123, &g_sys.config.ComPara.u16Sterilize_Time[17], 1, 0xFFFF, 1, 2, 1, NULL},
    ...
    {132, &g_sys.config.ComPara.u16Sterilize_Interval[2], 1, 0xFFFF, 1, 2, 1, NULL},
    {133, &g_sys.config.ComPara.u16Sterilize_Interval[3], 1, 0xFFFF, 1, 2, 1, NULL},
    {134, &g_sys.config.ComPara.u16Sterilize_Interval[4], 1, 0xFFFF, 1, 2, 1, NULL},
    {135, &g_sys.config.ComPara.u16Sterilize_Interval[5], 1, 0xFFFF, 1, 2, 1, NULL},
    {136, &g_sys.config.ComPara.u16Sterilize_Interval[6], 1, 0xFFFF, 1, 2, 1, NULL},
    {137, &g_sys.config.ComPara.u16Sterilize_Interval[7], 1, 0xFFFF, 1, 2, 1, NULL},
    {138, &g_sys.config.ComPara.u16Sterilize_Interval[8], 1, 0xFFFF, 1, 2, 1, NULL},
    {139, &g_sys.config.ComPara.u16Sterilize_Interval[9], 1, 0xFFFF, 1, 2, 1, NULL},
    {140, &g_sys.config.ComPara.u16Sterilize_Interval[10], 1, 0xFFFF, 1, 2, 1, NULL},
    {141, &g_sys.config.ComPara.u16Sterilize_Interval[11], 1, 0xFFFF, 1, 2, 1, NULL},
    {142, &g_sys.config.ComPara.u16Sterilize_Interval[12], 1, 0xFFFF, 1, 2, 1, NULL},
    {143, &g_sys.config.ComPara.u16Sterilize_Interval[13], 1, 0xFFFF, 1, 2, 1, NULL},
    {144, &g_sys.config.ComPara.u16Sterilize_Interval[14], 1, 0xFFFF, 1, 2, 1, NULL},
    {145, &g_sys.config.ComPara.u16Sterilize_Interval[15], 1, 0xFFFF, 1, 2, 1, NULL},
    {146, &g_sys.config.ComPara.u16Sterilize_Interval[16], 1, 0xFFFF, 1, 2, 1, NULL},
    {147, &g_sys.config.ComPara.u16Sterilize_Interval[17], 1, 0xFFFF, 1, 2, 1, NULL},
    ...
    {181, &g_sys.config.ComPara.u16Sterilize_Enable[1], 0, 1, 0, 2, 1, NULL},
    {182, &g_sys.config.ComPara.u16Sterilize_Enable[2], 0, 1, 0, 2, 1, NULL},
    {183, &g_sys.config.ComPara.u16Sterilize_Enable[3], 0, 1, 0, 2, 1, NULL},
    {184, &g_sys.config.ComPara.u16Sterilize_Enable[4], 0, 1, 0, 2, 1, NULL},
    {185, &g_sys.config.ComPara.u16Sterilize_Enable[5], 0, 1, 0, 2, 1, NULL},
    {186, &g_sys.config.ComPara.u16Sterilize_Enable[6], 0, 1, 0, 2, 1, NULL},
    {187, &g_sys.config.ComPara.u16Sterilize_Enable[7], 0, 1, 0, 2, 1, NULL},
    {188, &g_sys.config.ComPara.u16Sterilize_Enable[8], 0, 1, 0, 2, 1, NULL},
    {189, &g_sys.config.ComPara.u16Sterilize_Enable[9], 0, 1, 0, 2, 1, NULL},
    {190, &g_sys.config.ComPara.u16Sterilize_Enable[10], 0, 1, 0, 2, 1, NULL},
    {191, &g_sys.config.ComPara.u16Sterilize_Enable[11], 0, 1, 0, 2, 1, NULL},
    {192, &g_sys.config.ComPara.u16Sterilize_Enable[12], 0, 1, 0, 2, 1, NULL},
    {193, &g_sys.config.ComPara.u16Sterilize_Enable[13], 0, 1, 0, 2, 1, NULL},
    {194, &g_sys.config.ComPara.u16Sterilize_Enable[14], 0, 1, 0, 2, 1, NULL},
    {195, &g_sys.config.ComPara.u16Sterilize_Enable[15], 0, 1, 0, 2, 1, NULL},
    {196, &g_sys.config.ComPara.u16Sterilize_Enable[16], 0, 1, 0, 2, 1, NULL},
    {197, &g_sys.config.ComPara.u16Sterilize_Enable[17], 0, 1, 0, 2, 1, NULL},
    ...
    {312, &g_sys.config.ComPara.OTA_operate, 0, 0xFFFF, 0, 2, 1, NULL},
    /******************** network Config ***********************************************/
