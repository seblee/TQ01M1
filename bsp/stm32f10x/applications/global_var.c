...
const conf_reg_map_st conf_reg_map_inst[CONF_REG_MAP_NUM] = {
    ...
    {43, &g_sys.config.ComPara.u16Sterilize_Time[0], 1, 600, 10, 2, 1, NULL},
    {44, &g_sys.config.ComPara.u16Sterilize_Interval[0], 1, 10000, 10, 2, 1, NULL},
    ...
    {53, &g_sys.config.ComPara.u16Sterilize_Time[1], 1, 600, 10, 2, 1, NULL},
    {54, &g_sys.config.ComPara.u16Sterilize_Interval[1], 1, 10000, 10, 2, 1, NULL},
