...
//		{				8,      &g_sys.config.dev_mask.din_bitmap_polarity[0],					 0,				  	0xffff,			0xE24,				3,					1,      NULL   	},// DI极性
		...
		{				22,			&g_sys.config.compressor.startup_delay,								 	 0,			  	600,				  5,						2,					1,      NULL   	},
		{				23,			&g_sys.config.compressor.stop_delay,										 10,			  	90,					20,						2,					1,      NULL   	},
		...
		{				36,			&g_sys.config.ComPara.u16Power_Mode,									   0,				  	1,				  0,					  2,					1,      NULL   	},
		...
		{				41,			&g_sys.config.ComPara.u16Start_Defrost_Temp,						 0,			     0xFFFF,			-30,					2,					1,      NULL   	},
		{				42,			&g_sys.config.ComPara.u16Stop_Defrost_Temp,							 0,			 		 0xFFFF,			 60,					2,					1,      NULL   	},
		{				43,			&g_sys.config.ComPara.u16Sterilize_Time[0],							 1,				   60,				  6,					  2,					1,      NULL   	},
		{				44,			&g_sys.config.ComPara.u16Sterilize_Interval[0],					 1,				   10000,				30,					2,					1,      NULL   	},
		{				45,			&g_sys.config.ComPara.u16Water_Ctrl,									   0,				  	0xFFFF,			0,					  2,					1,      NULL   	},
		...
		{				49,			&g_sys.config.ComPara.u16HotWater_Temp,									 0,				  1000,			    600,					2,					1,      NULL   	},
