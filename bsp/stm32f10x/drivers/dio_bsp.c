...
//#define DIN_MASK_MASK1        0xffff //∆¡±Œ
...
//		din_bitmap_polarity[0]=0x5B;
	  //mask±®æØ—⁄¬Î
		...
		gds_sys_ptr->status.din_bitmap[1] |= ((din_mask_bitmap[1] & dio_dev_inst.din.bitmap[1])<<8);//∑≈µΩ∏ﬂ16Œª
