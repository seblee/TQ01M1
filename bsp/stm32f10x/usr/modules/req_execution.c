...
void Cold_Water_exe(void)
{
		...
		{
			if((sys_get_di_sts(DI_DRINK_DOWN_BPOS))&&(sys_get_di_sts(DI_DRINK_MU_BPOS)))//到达中上水位
			{
					...
					if((i16Water_Temp!=ABNORMAL_VALUE)&&(i16Water_Temp<g_sys.config.ComPara.u16ColdWater_StopTemp))//关闭 
					{
